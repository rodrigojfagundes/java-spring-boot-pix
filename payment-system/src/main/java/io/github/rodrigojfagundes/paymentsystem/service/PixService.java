...
import io.github.rodrigojfagundes.paymentsystem.pix.Credentials;

@Service
public class PixService {
	
    //@Value("${CLIENT_ID}")
    private String clientId = "Client_Id_Gerado_Pelo_Banco_EFI";

//    @Value("${CLIENT_SECRET}")
    private String clientSecret = "Client_Secret_Gerado_Pelo_Banco_EFI";
